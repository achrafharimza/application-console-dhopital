...
public class Infermiere extends Person{
	...
	public Infermiere(String firstname, String lastname, String phone, String address,String professionNumber, TimeSlot shiftSlot, double salary) {
	...
	public String toString() {
		return "Infermiere ["+super.toString()+"professionNumber=" + professionNumber + ", shiftSlot=" + shiftSlot + ", salary=" + salary
				+ "]";
	}
